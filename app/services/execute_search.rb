class ExecuteSearch
  ...
  def execute(type, search_criteria)
    ...
    case type
     ...
     when :notes
       return sservice.textSearch_notes(search_criteria.query, search_criteria.limit)
     when :questions
       return sservice.textSearch_questions(search_criteria.query, search_criteria.limit)
     when :tags
       return sservice.textSearch_tags(search_criteria.query, search_criteria.limit)
     when :places
